...
import {ChannelAndGroupDescriptionValidation, ChannelAndGroupNameValidation} from "../../constants/validation";
...
const CreateGroup = ()=> {
    ...
    const {control, watch,handleSubmit, reset}=useForm<CreateGroupForm>({defaultValues:{
        name:'',
            description:''
    }})
